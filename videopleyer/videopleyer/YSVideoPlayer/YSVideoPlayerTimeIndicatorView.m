//
//  YSVideoPlayerTimeIndicatorView.m
//  videopleyer
//
...
@interface YSVideoPlayerTimeIndicatorView()

@property (nonatomic, strong, readwrite) UIImageView *arrowImageView;
@property (nonatomic, strong, readwrite) UILabel     *timeLabel;

@end
@implementation YSVideoPlayerTimeIndicatorView
...
- (void)layoutSubviews
{
    ...
    if (self.playState == YSTimeIndicatorPlayStateRewind) {
